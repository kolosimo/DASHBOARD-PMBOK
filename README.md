...
**Stato:** ricerca verificata; [prototipo cliccabile](prototipo/index.html) con dati di esempio (anteprima privata: https://claude.ai/artifact/Hau6bbX46GViVFRhGNUykN). Codice dell'app non ancora iniziato.

- [Sintesi e decisioni (rev. 2)](docs/00-sintesi-e-decisioni.md)
- Ricerca: [PMBOK](docs/ricerca/01-pmbok.md) · [Lean](docs/ricerca/02-lean-progettazione.md) · [Tool open source](docs/ricerca/03-tool-open-source.md) · [Architettura rev. 1](docs/ricerca/04-architettura.md) · [KPI MEP/BIM](docs/ricerca/05-kpi-settore-mep-bim.md) · [GoodDay (archiviato)](docs/ricerca/06-goodday-ore.md) · [Verifica affermazioni](docs/ricerca/07-verifica-affermazioni.md) · [App Windows/Mac](docs/ricerca/08-app-installabile-win-mac.md)
