...
**Stato:** ricerca verificata; [prototipo cliccabile](prototipo/index.html) con dati di esempio (anteprima privata: https://claude.ai/artifact/Hau6bbX46GViVFRhGNUykN). Fase 0 (fondamenta) completata: app AdonisJS 7 + PostgreSQL con modello dati, login, permessi e moduli segnaposto. Per sviluppare: [CLAUDE.md](CLAUDE.md) e [ambiente](docs/sviluppo/ambiente.md).
