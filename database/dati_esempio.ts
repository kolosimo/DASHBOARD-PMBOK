...
export const STATI = [
  ...
  { codice: 'calcoli', nome: 'Calcoli e dimensionamento', ordine: 2, peso: 50, colonna: 'in_corso' },
  { codice: 'emissione_interna', nome: 'Emissione interna', ordine: 3, peso: 70, colonna: 'in_verifica' },
...
export const ELABORATI = [
  { codice: 'MEC-RT-001', titolo: 'Relazione tecnica impianti meccanici', d: 'MEC', bud: 40, st: 3, ac: 31, pv: 4, age: 6, cls: 'standard', resp: 'mec1' },
  { codice: 'MEC-CA-002', titolo: 'Calcolo carichi termici invernali ed estivi', d: 'MEC', bud: 60, st: 5, ac: 66, pv: 5, age: 0, cls: 'standard', resp: 'mec2' },
  { codice: 'MEC-PL-101', titolo: 'Pianta PT – impianto di riscaldamento', d: 'MEC', bud: 48, st: 2, ac: 30, pv: 4, age: 12, cls: 'standard', resp: 'mec1' },
  { codice: 'MEC-PL-102', titolo: 'Pianta P1 – impianto di riscaldamento', d: 'MEC', bud: 48, st: 1, ac: 14, pv: 3, age: 4, cls: 'standard', resp: 'mec1' },
  { codice: 'MEC-PL-110', titolo: 'VMC – piante e schemi funzionali', d: 'MEC', bud: 56, st: 2, ac: 38, pv: 3, age: 9, cls: 'standard', resp: 'mec2' },
  { codice: 'ELE-SC-201', titolo: 'Schemi quadri elettrici', d: 'ELE', bud: 64, st: 2, ac: 40, pv: 2, age: 15, cls: 'standard', resp: 'ele1' },
  { codice: 'ELE-PL-210', titolo: 'Pianta PT – illuminazione', d: 'ELE', bud: 36, st: 3, ac: 24, pv: 3, age: 3, cls: 'standard', resp: 'ele2' },
  { codice: 'IDR-PL-301', titolo: 'Impianto idrico-sanitario – piante', d: 'IDR', bud: 40, st: 1, ac: 18, pv: 2, age: 5, cls: 'standard', resp: 'idr1' },
  { codice: 'ANT-RT-401', titolo: 'Relazione tecnica antincendio', d: 'ANT', bud: 32, st: 4, ac: 30, pv: 4, age: 2, cls: 'data_fissa', resp: 'pm1', dataFissa: '2026-09-30' },
] as const
...
export const IMPEGNI_W39 = [
  { descrizione: 'Completare dimensionamento radiatori PT', elaborato: 'MEC-PL-101', lp: 'mec1', fatto: true, causa: null },
  { descrizione: 'Schemi VMC aula tipo', elaborato: 'MEC-PL-110', lp: 'mec2', fatto: true, causa: null },
  { descrizione: 'Schema quadro elettrico generale', elaborato: 'ELE-SC-201', lp: 'ele1', fatto: false, causa: 'input_mancante' },
  { descrizione: 'Impostazione tavola idrico PT', elaborato: 'IDR-PL-301', lp: 'idr1', fatto: true, causa: null },
  { descrizione: 'Verifica interna relazione antincendio', elaborato: 'ANT-RT-401', lp: 'pm1', fatto: false, causa: 'risorsa_non_disponibile' },
  { descrizione: 'Revisione relazione dopo commenti di verifica', elaborato: 'MEC-RT-001', lp: 'mec1', fatto: true, causa: null },
  { descrizione: 'Calcolo illuminotecnico corridoi', elaborato: 'ELE-PL-210', lp: 'ele2', fatto: true, causa: null },
] as const
...
export const LOOKAHEAD = [
  { codice: 'L1', titolo: 'MEC-PL-102 · Pianta P1 riscaldamento', da: 40, a: 41, elaborato: 'MEC-PL-102' },
  { codice: 'L2', titolo: 'ELE-SC-201 · Schemi quadri elettrici', da: 40, a: 42, elaborato: 'ELE-SC-201' },
  { codice: 'L3', titolo: 'ELE-PL-210 · Emissione illuminazione PT', da: 40, a: 40, elaborato: 'ELE-PL-210' },
  { codice: 'L5', titolo: 'ANT-RT-401 · Emissione relazione antincendio', da: 40, a: 40, elaborato: 'ANT-RT-401' },
  { codice: 'L4', titolo: 'MEC-PL-110 · VMC piante e schemi', da: 41, a: 43, elaborato: 'MEC-PL-110' },
  { codice: 'L7', titolo: 'IDR-PL-301 · Idrico-sanitario piante', da: 41, a: 42, elaborato: 'IDR-PL-301' },
  { codice: 'L6', titolo: 'Coordinamento impianti / strutture', da: 42, a: 43, elaborato: null },
  { codice: 'M1', titolo: 'Milestone · Esecutivo meccanico', da: 44, a: 44, milestone: 'Esecutivo meccanico' },
  { codice: 'M2', titolo: 'Milestone · Esecutivo elettrico', da: 45, a: 45, milestone: 'Esecutivo elettrico' },
] as const

/** Registro vincoli. resp = slug utente oppure testo esterno */
export const VINCOLI = [
  { codice: 'V-12', descrizione: "Layout arredi P1 dall'architetto", categoria: 'input_da_altri', attivita: ['L1'], resp: 'pm1', serveEntro: '2026-09-29', rimosso: false },
  { codice: 'V-13', descrizione: 'Planimetria architettonica rev. C', categoria: 'input_da_altri', attivita: ['L2'], resp: 'pm1', serveEntro: '2026-09-29', rimosso: false },
  { codice: 'V-14', descrizione: "Conferma ricambi d'aria dal committente", categoria: 'approvazione', attivita: ['L4'], resp: 'pm1', serveEntro: '2026-10-06', rimosso: false },
  { codice: 'V-15', descrizione: 'Verificatore interno disponibile', categoria: 'risorsa', attivita: ['L5'], resp: 'qualita', serveEntro: '2026-09-29', rimosso: false },
  { codice: 'V-16', descrizione: 'Tavole strutturali aggiornate dallo strutturista', categoria: 'input_da_altri', attivita: ['L6'], resp: 'pm1', serveEntro: '2026-10-13', rimosso: false },
  { codice: 'V-17', descrizione: 'Criteri illuminotecnici approvati', categoria: 'criteri', attivita: ['L3'], resp: 'ele1', serveEntro: '2026-10-06', rimosso: true },
] as const

/** PV cumulato (ore) per settimana W30…W46, congelato nella baseline */
export const PV_SERIE = [0, 18, 45, 80, 122, 168, 212, 252, 285, 312, 340, 362, 382, 398, 410, 419, 424]
